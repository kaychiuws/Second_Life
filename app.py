...
if not st.session_state.game_started:
    ...
    def run_turn(choice_text=""):
        ...
        【文學過渡鐵律（極重要）】：這是一個跨越19年的長篇故事，每個回合之間相隔數月甚至一年。為了避免敘事急促，你的 `story_text` 必須嚴格分為三個段落，全文必需至少有500字：
        [第一段：歲月餘波（蒙太奇）]：用1-2句充滿感官細節的文學語言，描寫「上一步抉擇」在隨後幾個月裡帶來的餘波、生活的磨耗或是短暫的平靜。讓玩家感受到時間的流逝（例如：「那隻交出去的手錶換來了半年的平靜，直到初冬的霜凍爬上窗櫺...」）。
        [第二段：齒輪轉動（當下大氣侯）]：鏡頭切換，以冷峻的白描手法切入當前年份的【目前歷史齒輪】種種，包括但不限於環境、政治氣氛、社區氣氛、主流或非主流價值觀及信念、主流或非主流心理及精神狀態，使玩家能沉浸式多感官感受當下。
        [第三段：命運（當下危機）]將日常的異狀推到玩家面前，逼迫他們做出新的物理抉擇。
        """
